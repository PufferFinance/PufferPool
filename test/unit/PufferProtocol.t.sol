...
contract PufferProtocolTest is TestHelper {
    ...
    function test_skip_provisioning() public {
        ...
        pufferProtocol.provisionNode(signatures, 1 days, 0);
    ...
    function test_module_DOS() external {
        ...
        pufferProtocol.provisionNode(_getGuardianSignatures(_getPubKey(bytes32("alice"))), 1 days, 0);
        ...
        pufferProtocol.provisionNode(_getGuardianSignatures(_getPubKey(bytes32("ford"))), 1 days, 0);
    ...
    function test_stop_registration() public {
        ...
        pufferProtocol.provisionNode(_getGuardianSignatures(_getPubKey(bytes32("bob"))), 1 days, 0);
    ...
    function test_register_multiple_validator_keys_and_dequeue(bytes32 alicePubKeyPart, bytes32 bobPubKeyPart) public {
        ...
        pufferProtocol.provisionNode(bobSignatures, 1 days, 0);
    ...
    function test_claim_bond() public {
        ...
        pufferProtocol.provisionNode(_getGuardianSignatures(_getPubKey(bytes32("alice"))), 1 days, 0);
        pufferProtocol.provisionNode(_getGuardianSignatures(_getPubKey(bytes32("bob"))), 1 days, 0);
        pufferProtocol.provisionNode(_getGuardianSignatures(_getPubKey(bytes32("charlie"))), 1 days, 0);
    ...
    function test_validator_griefing_attack() external {
        ...
        pufferProtocol.provisionNode(guardianSignatures, 1 days, 0);
    ...
    function test_vt_balance_different_provision_time() public {
        ...
        pufferProtocol.provisionNode(_getGuardianSignatures(_getPubKey(bytes32("alice"))), 3 days, 0);
        ...
        pufferProtocol.provisionNode(_getGuardianSignatures(_getPubKey(bytes32("alice"))), 2 days, 1 ether);
        ...
        assertApproxEqRel(
            pufferProtocol.geValidatorTicketsBalance(alice), 69 ether, pointZeroZeroOne, "alice should have ~20 VTS"
        );
    }
    ...
    function test_register_skip_provision_withdraw_vt() public {
        ...
        assertApproxEqRel(
            ...
            30 ether,
            pointZeroZeroOne,
            "alice should have ~30 VTS again"
        );

        pufferProtocol.withdrawValidatorTickets(uint128(30 ether), alice);

        assertEq(validatorTicket.balanceOf(alice), 30 ether, "alice got her VT");
    }
    ...
    function test_vt_balance_multiple_validators() public {
        ...
        pufferProtocol.provisionNode(_getGuardianSignatures(_getPubKey(bytes32("alice"))), 1 days, 1 ether);
