...
contract EnclaveVerifierTest is Test {
    ...
    function setUp() public {
        validEvidence = new ValidBLSEvidence();
    ...
    function testVerifyValidatorPubKey() public {
        ...
        // verifier.addLeafX509(validEvidence.signingCert());

        // IEnclaveVerifier.RaveEvidence memory evidence = IEnclaveVerifier.RaveEvidence({
        //     report: validEvidence.report(),
        //     signature: validEvidence.sig(),
        //     leafX509CertDigest: keccak256(validEvidence.signingCert())
        // });

        // bool success = verifier.verifyValidatorPubKey({
        //     pubKey: validEvidence.payload(),
        //     blockNumber: 0,
        //     evidence: evidence,
        //     mrenclave: validEvidence.mrenclave(),
        //     mrsigner: validEvidence.mrsigner()
        // });
